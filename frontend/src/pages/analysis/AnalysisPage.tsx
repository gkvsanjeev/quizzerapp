...
import { QuestionsTableSection } from '@/components/analysis/QuestionsTableSection'
    ...
    >
      ...
      <Tabs defaultValue="overview">
        ...
        <TabsContent value="subject-movement" className="mt-4">
          <SubjectMovementSection attemptId={attemptId} />
        </TabsContent>
        ...
        <TabsContent value="questions" className="mt-4">
          <QuestionsTableSection attemptId={attemptId} />
        </TabsContent>
      </Tabs>
    </TeacherPageShell>
  )
